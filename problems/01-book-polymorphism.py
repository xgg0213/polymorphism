...
class Book:
    ...
    def description(self):
        return f"{self._title} is written by {self._author} and was published in {self._year}."
...
class NonfictionBook(Book):
    ...
    def description(self):
        return f"{self._title} is written by {self._author} and was published in {self._year}. It is a nonfiction book about {self._subject}."
